...
public class Ui {
    ...
    public void showEnterCategoryPrompt() {
        showLine();
        System.out.println("Enter the category: else enter -back to change expense amount "
                            + "or -exit to exit add command");
        showLine();
    }
    //@@author zihaoalt
    ...
    public void showEnterDatePrompt() {
        ...
        System.out.println("Enter the date (yyyy-MM-dd or today):"
                            + " or -back to change expense category or -exit to exit add command");
        showLine();
    }
